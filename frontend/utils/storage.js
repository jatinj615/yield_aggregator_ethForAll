...
// ? used for retrieving and setting sessionStorage data in web and framework through a consistent api surface
export const getSessionItem = (key, self) => {
  return JSON.parse(sessionStorage.getItem(key));
};

export const setSessionItem = (key, value) => {
  // ? set it on sessionStorage
